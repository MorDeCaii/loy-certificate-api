...
// Source: github.com/Mordecaii/loy-certificate-api/internal/app/sender (interfaces: EventSender)
...
func (m *MockEventSender) Send(arg0 *model.CertificateEvent) error {
	m.ctrl.T.Helper()
